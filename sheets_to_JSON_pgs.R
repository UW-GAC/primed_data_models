...
# link to the data
url <- "https://docs.google.com/spreadsheets/d/1a-o3IIiRj7r-X6kd_l5uMTJb7wWQBsdq2yEvZX5mct8"
model_name <- "PRIMED PGS Data Model"
...
write(out, "PRIMED_PGS_data_model.json")
